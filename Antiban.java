...
public class Antiban extends Task {
    ...
    //All antiban variables are intialized so that they can be manipulated within the class if needed.
    //Variables are checked in the switch statement, but will remain true until i find a reason to change
